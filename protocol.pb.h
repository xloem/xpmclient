...
inline void Signal::set_type(::pool::proto::Signal_Type value) {
  GOOGLE_DCHECK(::pool::proto::Signal_Type_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void Request::set_type(::pool::proto::Request_Type value) {
  GOOGLE_DCHECK(::pool::proto::Request_Type_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void Reply::set_error(::pool::proto::Reply_ErrType value) {
  GOOGLE_DCHECK(::pool::proto::Reply_ErrType_IsValid(value));
  set_has_error();
  error_ = value;
}
